#!/bin/sh
# Installs the game on this server's nginx as /simitci/ and checks that it opens.
# Run on the server as root:
#   curl -fsSL https://raw.githubusercontent.com/koid38/super-meme/HEAD/simitci/deploy.sh | sh
set -e

SRC="https://raw.githubusercontent.com/koid38/super-meme/HEAD/simitci/index.html?t=$(date +%s)"
NAME="simitci"
